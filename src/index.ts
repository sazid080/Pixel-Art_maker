...
let isDrawing = false;
let currentTool: 'pencil' | 'eraser' = 'pencil';
...
const currentColorDiv = document.getElementById('currentColor') as HTMLDivElement;
const pencilBtn = document.getElementById('pencilBtn') as HTMLButtonElement;
...
function paintPixel(pixel: HTMLDivElement) {
...
function setTool(tool: 'pencil' | 'eraser') {
    currentTool = tool;
